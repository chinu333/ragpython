...
print(f"Using OpenAI endpoint: {openaiendpoint}")
print(f"Using OpenAI deployment name: {openapideploymentname}")
print(f"Using OpenAI API version: {aiapiversion}")
print(f"Using OpenAI API key: {openaikey}")
